...
% \begin{align*}
%     f(x, y) = \abs{\frac{\delt x+y}{\delta x}} \cdot \Delta x + \abs{\frac{\delta x+y}{\delta y}} \cdot \Delta y = \Delta x + \Delta y
% \end{align*}
\begin{align*}
...
\begin{align*}
    ...
    T = \frac{\Delta E}{k_b}
\end{align*}
\input{../src/tabellen/schwingungen.tex}
...
\input{../src/tabellen/besetzungszahlen.tex}
